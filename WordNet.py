...
class WordNet:
    def __init__(self, doc_vector_size=100, filter_sizes=[2, 3, 4, 5, 6], dropout_p=0.5, n_tokens=50,
                 n_feature_maps=2, n_classes=2, embedding=False, hidden_layer_sizes=[], convolution=2,
